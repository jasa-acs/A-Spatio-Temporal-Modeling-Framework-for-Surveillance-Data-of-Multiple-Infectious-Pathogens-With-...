...
#include "mcmc_agg_functions.h"

int main (int argc, char* argv[])
{
    if (argc < 5) {
        printf("\nPlease provide label of the data set, index of simulation data, index of mcmc chains, and agg_method (agg or agg_prov) as extra arguments!\n");
        return 0;
    }
    
    char *data_label, *agg_method;
    ...
    // variables for Y
    double sum_Z=0.0;
    int sum_Z_int=0, sum_Y=0, Y_new, Y_nv_new, numY, diffY;
    ...
    sprintf(filename, "simulation/sim_data/south5_Z_%s_simdata_%s_rep%d.txt", agg_method, data_label, index_epi);
    file = fopen(filename, "r");
    if (file == NULL)
    {
        printf("Can't open Z_agg file!\n");
    }
    else
    {
        for (v=0; v < n_v; v++)
            ...
            for (t=1; t < n_week-1; t++)
            {
                for (s=0; s < n_s; s++)
                {
                    for (r=0; r < n_region; r++)
                    {
                        ...
                        logacprate = 0.0;
                        for (v = 0; v < n_v; v++) logacprate += logpmfY_fun(old_Y_block[v],polygons,r,s,t,v,gamma0,gamma1,gamma2,eta_E,eta_S) - (old_Y_block[v] - ceil(polygons[r].Z_agg[s][t][v])) * log(pmf_Y[v]) + lgamma(old_Y_block[v] - ceil(polygons[r].Z_agg[s][t][v]) + 1);
                        
                        logacprate = -1.0*logacprate;
                        
                        for (v = 0; v < n_v; v++) logacprate += logpmfY_fun(new_Y_block[v],polygons,r,s,t,v,gamma0,gamma1,gamma2,eta_E,eta_S) - (new_Y_block[v] - ceil(polygons[r].Z_agg[s][t][v])) * log(pmf_Y[v]) + lgamma(new_Y_block[v] - ceil(polygons[r].Z_agg[s][t][v]) + 1);
    ...
    for (i=0; i < n_sim + n_burn; i++)
    {
        ...
        {
            sprintf(filename, "simulation/output_chains/Y_output_simdata_%s_%s_%d_%d.txt", agg_method, data_label, index_epi, index_chain);
            ...
            sprintf(filename, "simulation/output_chains/gamma0_output_simdata_%s_%s_%d_%d.txt", agg_method, data_label, index_epi, index_chain);
            file = fopen(filename, "a");
            if (file == NULL)
            {
            ...
            sprintf(filename, "simulation/output_chains/gamma1_output_simdata_%s_%s_%d_%d.txt", agg_method, data_label, index_epi, index_chain);
            file = fopen(filename, "a");
            if (file == NULL)
            {
            ...
            sprintf(filename, "simulation/output_chains/gamma2_output_simdata_%s_%s_%d_%d.txt", agg_method, data_label, index_epi, index_chain);
            file = fopen(filename, "a");
            if (file == NULL)
            {
            ...
            sprintf(filename, "simulation/output_chains/alpha_element_output_simdata_%s_%s_%d_%d.txt", agg_method, data_label, index_epi, index_chain);
            file = fopen(filename, "a");
            if (file == NULL)
            {
            ...
            sprintf(filename, "simulation/output_chains/sigma2_alpha_output_simdata_%s_%s_%d_%d.txt", agg_method, data_label, index_epi, index_chain);
            file = fopen(filename, "a");
            if (file == NULL)
            {
            ...
            sprintf(filename, "simulation/output_chains/beta_fix_output_simdata_%s_%s_%d_%d.txt", agg_method, data_label, index_epi, index_chain);
            file = fopen(filename, "a");
            if (file == NULL)
            {
            ...
            sprintf(filename, "simulation/output_chains/eta_P_output_simdata_%s_%s_%d_%d.txt", agg_method, data_label, index_epi, index_chain);
            file = fopen(filename, "a");
            ...
            sprintf(filename, "simulation/output_chains/eta_P0_output_simdata_%s_%s_%d_%d.txt", agg_method, data_label, index_epi, index_chain);
            file = fopen(filename, "a");
            ...
            sprintf(filename, "simulation/output_chains/eta_S_output_simdata_%s_%s_%d_%d.txt", agg_method, data_label, index_epi, index_chain);
            file = fopen(filename, "a");
            ...
            sprintf(filename, "simulation/output_chains/eta_E_output_simdata_%s_%s_%d_%d.txt", agg_method, data_label, index_epi, index_chain);
            file = fopen(filename, "a");
    ...
    sprintf(filename, "simulation/output_chains/acceptance_rate_output_simdata_%s_%s_%d_%d.txt", agg_method, data_label, index_epi, index_chain);
    file = fopen(filename, "a");
    fprintf(file, "gamma0\n");
   ...
   for (v=0; v < n_v; v++) fprintf(file, "v=%d %f\n", v, (double)n_accept_alphas[v]/(n_sim + n_burn));
    ...
    sprintf(filename, "simulation/output_chains/tuning_para_output_simdata_%s_%s_%d_%d.txt", agg_method, data_label, index_epi, index_chain);
    file = fopen(filename, "a");
    fprintf(file, "gamma0\n");
    for (v=0; v < n_v; v++) fprintf(file, "v=%d %f\n", v, tuning_gamma0[v]);
