...
nchain <- 5
nsize <- 10000
npara <- 4 # 1: two week balanced 2%; 2: two week imbalacned 2%; 3: one week balanced 2%; 4: one week imbalanced 2%
...
for (index.epi in 1:nepi)
{
	for (index.para in 1:npara)
	{
		...
		{
			if (index.para == 1) load(paste("simulation/output_chains/south5_simdata_2infweek_balanced_combo1_", index.epi, "_", index.chain, "_results.RData", sep=""))
			else if (index.para == 2) load(paste("simulation/output_chains/south5_simdata_2infweek_imbalanced_combo1_", index.epi, "_", index.chain, "_results.RData", sep=""))
			...
			else load(paste("simulation/output_chains/south5_simdata_imbalanced_combo1_block_", index.epi, "_", index.chain, "_results.RData", sep=""))
...
save(bmse_res, stat_res, file="simulation/results_summary/summary_simulation_2infweek_results.RData")
