...
nchain <- 5
nsize <- 10000
npara <- 6 # 1: balanced 2% agg by nb; 2: imbalanced 2% agg by nb; 3: balanced 2% no agg; 4: imbalanced 2% no agg; 5: balanced 2% agg by prov; 6: imbalanced 2% agg by prov
...
for (index.epi in 1:nepi)
{
	for (index.para in 1:npara)
	{
		...
		{
			if (index.para == 1) load(paste("simulation/output_chains/south5_simdata_agg_balanced_combo1_", index.epi, "_", index.chain, "_results.RData", sep=""))
			else if (index.para == 2) load(paste("simulation/output_chains/south5_simdata_agg_imbalanced_combo1_", index.epi, "_", index.chain, "_results.RData", sep=""))
			else if (index.para == 3) load(paste("simulation/output_chains/south5_simdata_balanced_combo1_block_", index.epi, "_", index.chain, "_results.RData", sep=""))
			else if (index.para == 4) load(paste("simulation/output_chains/south5_simdata_imbalanced_combo1_block_", index.epi, "_", index.chain, "_results.RData", sep=""))
			else if (index.para == 5) load(paste("simulation/output_chains/south5_simdata_agg_prov_balanced_combo1_", index.epi, "_", index.chain, "_results.RData", sep=""))
			else if (index.para == 6) load(paste("simulation/output_chains/south5_simdata_agg_prov_imbalanced_combo1_", index.epi, "_", index.chain, "_results.RData", sep=""))
...
save(bmse_res, stat_res, file="simulation/results_summary/summary_simulation_agg_results.RData")
